...
#         self.inplanes = 16
        self.inplanes = inplanes ## self.inplanes changes in _make_layer
...
### Resnet with 4 blocks, 3 downsampling...
    
def cifar2_resnet20(**kwargs):
    model = CifarResNet2(BasicBlock, [2, 2, 2, 2], **kwargs)
    return model
